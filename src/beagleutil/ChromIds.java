...
public final class ChromIds {
    ...
    private volatile ImmutableArray<String> ids;
    ...
    private ChromIds() {
        ...
        this.ids = new ImmutableArray<>(new String[0]);
    }
    ...
    public String id(int index) {
        if (index >= ids.size()) {
            this.ids = new ImmutableArray<>(indexer.items().toArray(new String[0]));
        }
